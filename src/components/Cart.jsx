...
const Cart = () => {
    ...
    const { cart, setCart, removeItem, removeAll, calcularTotalCompra } = useContext(CounterContext);
    ...
    return (
        !cart.length ? <NoItemsLoad /> :
            <>
                <div className='bloqButtonClear'>
                    <button className='btn btn-danger btnClear' onClick={removeAll}>Vaciar carrito</button>
                </div>
                            ...
                            return (
                                <div key={item.id}>
                                    <div className="card cardWidget" >
                                        ...
                                        <div>
                                            <button className='buttonEliminar' onClick={() => removeItem(item.id)}>
                ...
                <div className='bloqButtonClear'>
                <p className='precioTotal'>Precio total: <span className='spanInfo'>${formatNumber(calcularTotalCompra())}</span></p>
                </div>
